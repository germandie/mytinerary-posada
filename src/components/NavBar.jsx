...
export default function NavBar() {
  ...
  return (
    <header className="h-[87px] px-12 flex justify-start items-center bg-blue-300">
      ...
      {show ? (
        <nav className="flex items-center space-x-4 mx-auto h-30 justify-between">
          <Anchor to = "/home" className="font-segoe-ui text-black text-lg font-semibold leading-8"
          >
            Home
          </Anchor>

          <Anchor to = "/cities" className=" font-segoe-ui text-black text-lg font-semibold leading-8"
          >
            Cities
          </Anchor>
